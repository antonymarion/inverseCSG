...
myNode0.point1.set(-0.003,0.005,-2.9549);
myNode0.point2.set(-0.003,0.005,-2.7281);
myNode0.radius.set(4.71);
myNode0.innerRotation.center.set(0,0,0);
myNode0.innerRotation.axis.set(4.168249100214226e-06,3.141592653580742,4.168249100214226e-06);
myNode0.innerRotation.angle.set(3.141592653586273);
myNode0.isVisible = false;

/* définition du node n°1*/
const myNode1 = object.addCylinder();
myNode1.point1.set(3.977,-0.001,-2.9549);
myNode1.point2.set(3.977,-0.001,2.7269);
...
myNode2.point1.set(-3.7589,-2.5009,2.5001);
myNode2.point2.set(-3.0681000000000003,2.5059,2.9549000000000003);
myNode2.innerRotation.center.set(0,0,0);
myNode2.innerRotation.axis.set(0.0,0.0,0.0);
myNode2.innerRotation.angle.set(0.0);
myNode2.innerTranslation.vector.set(-3.4135,0.0024999999999999467,2.7275);
myNode2.isVisible = false;

/* définition du node n°3*/
const myNode3 = object.addCylinder();
myNode3.point1.set(-2.373,3.759,-18.0999);
myNode3.point2.set(-2.373,3.759,18.099999999999998);
myNode3.radius.set(0.355);
myNode3.innerRotation.center.set(0,0,0);
myNode3.innerRotation.axis.set(-1.2091961203694672,1.2091973532731866,1.2092005619911987);
myNode3.innerRotation.angle.set(2.094392392986396);
...
myNode5.point1.set(-3.0679,-2.5009,2.5001);
myNode5.point2.set(-1.9880999999999998,2.5059,2.7269);
myNode5.innerRotation.center.set(0,0,0);
myNode5.innerRotation.axis.set(0.0,0.0,0.0);
myNode5.innerRotation.angle.set(0.0);
myNode5.innerTranslation.vector.set(-2.5279999999999996,0.0024999999999999467,2.6135);
myNode5.isVisible = false;

/* définition du node n°6*/
const myNode6 = object.addCylinder();
myNode6.point1.set(-2.379,1.922,-2.50095);
myNode6.point2.set(-2.379,1.922,2.50595);
myNode6.radius.set(0.352);
...
myNode8.point1.set(-3.0679,-2.5009,-2.9549);
myNode8.point2.set(-2.2731,-1.5911,2.9539000000000004);
myNode8.innerRotation.center.set(0,0,0);
myNode8.innerRotation.axis.set(0.0,0.0,0.0);
myNode8.innerRotation.angle.set(0.0);
myNode8.innerTranslation.vector.set(-2.6704999999999997,-2.0460000000000003,-0.0004999999999997229);
myNode8.isVisible = false;

/* définition du node n°9*/
const myNode9 = object.addCylinder();
myNode9.point1.set(-1.988,-3.445,2.5001);
myNode9.point2.set(-1.988,-3.445,2.9549000000000003);
myNode9.radius.set(0.452);
...
myNode11.point1.set(-0.003,0.005,-2.49995);
...
myNode12.point1.set(2.501,-1.865,-18.1);
myNode12.point2.set(2.501,-1.865,-2.2730000000000015);
myNode12.radius.set(0.219);
...
myNode14.point1.set(-0.003,0.005,2.95505);
...
myNode15.point1.set(3.977,0.001,-18.0999);
myNode15.point2.set(3.977,0.001,2.7269999999999968);
...
myNode16.point1.set(-0.045,-0.00100001,-18.0999);
myNode16.point2.set(-0.045,-0.00100001,18.099999999999998);
myNode16.radius.set(0.795);
myNode16.innerRotation.center.set(0,0,0);
myNode16.innerRotation.axis.set(0.0028938703161114103,0.017293063626353244,-0.3316045510476236);
myNode16.innerRotation.angle.set(0.3320677684004992);
myNode16.isVisible = false;

/* définition du node n°17*/
const myNode17 = object.addCylinder();
myNode17.point1.set(-1.987,-3.444,-18.0999);
myNode17.point2.set(-1.987,-3.444,2.7269999999999968);
...
myNode18.point1.set(-2.501,-2.501,-3.75895);
myNode18.point2.set(-2.501,-2.501,18.09995);
myNode18.radius.set(0.226);
...
myNode19.point1.set(-2.489,2.506,-18.0999);
myNode19.point2.set(-2.489,2.506,-1.988000000000003);
myNode19.radius.set(0.236);
...
myNode22.point1.set(-3.4089,-2.2729,-2.9549);
myNode22.point2.set(-2.2731000000000003,2.2719000000000005,2.7269);
myNode22.innerRotation.center.set(0,0,0);
myNode22.innerRotation.axis.set(0.0,0.0,0.0);
myNode22.innerRotation.angle.set(0.0);
myNode22.innerTranslation.vector.set(-2.841,-0.0004999999999997229,-0.11399999999999988);
myNode22.isVisible = false;

/* définition du node n°23*/
const myNode23 = object.addCylinder();
myNode23.point1.set(-1.987,3.445,2.5001);
myNode23.point2.set(-1.987,3.445,18.0999);
...
myNode25.point2.set(18.09995,1.5909500000000003,-2.955000000000002);
myNode25.innerRotation.center.set(0,0,0);
myNode25.innerRotation.axis.set(0.0,0.0,0.0);
myNode25.innerRotation.angle.set(0.0);
myNode25.innerTranslation.vector.set(8.056000000000001,-0.34099999999999975,-10.527450000000002);
...
myNode27.point2.set(-0.016,-0.01,2.9549);
...
myNode28.point2.set(-0.003,0.005,-1.591000000000001);
...
myNode33.point1.set(-1.989,3.444,2.50005);
myNode33.point2.set(-1.989,3.444,2.72695);
myNode33.radius.set(0.113);
...
myNode34.point1.set(-3.75895,2.27305,1.59105);
myNode34.point2.set(-2.72705,2.50595,2.72695);
myNode34.innerRotation.center.set(0,0,0);
myNode34.innerRotation.axis.set(0.0,0.0,0.0);
myNode34.innerRotation.angle.set(0.0);
myNode34.innerTranslation.vector.set(-3.243,2.3895,2.159);
myNode34.isVisible = false;

/* définition du node n°35*/
const myNode35 = object.addBox();
myNode35.point1.set(-3.06795,-1.76095,-2.95495);
myNode35.point2.set(-2.72705,1.76195,1.8179499999999997);
myNode35.innerRotation.center.set(0,0,0);
myNode35.innerRotation.axis.set(0.0,0.0,0.0);
myNode35.innerRotation.angle.set(0.0);
myNode35.innerTranslation.vector.set(-2.8975,0.0004999999999999449,-0.5685000000000002);
...
myNode42.point1.set(-3.75895,-1.59095,-2.95495);
myNode42.point2.set(-2.27205,1.59095,1.7039499999999999);
myNode42.innerRotation.center.set(0,0,0);
myNode42.innerRotation.axis.set(0.0,0.0,0.0);
myNode42.innerRotation.angle.set(0.0);
myNode42.innerTranslation.vector.set(-3.0155,0.0,-0.6255000000000002);
