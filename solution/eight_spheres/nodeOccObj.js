...
myNode0.center.set(0,0,0);
myNode0.radius.set(1.1325899522775222);
myNode0.isVisible = false;

/* définition du node n°1*/
const myNode1 = object.addSphere();
myNode1.center.set(0,0.943909,0);
myNode1.radius.set(1.0382003660180437);
...
myNode5.center.set(-3.1149,-1.98221,-0.094391);
myNode5.radius.set(0.7550271518296544);
myNode5.isVisible = false;

/* définition du node n°6*/
const myNode6 = object.addSphere();
myNode6.center.set(1.41586,-2.92612,3.77564);
myNode6.radius.set(1.8877208480069292);
myNode6.isVisible = false;

/* définition du node n°7*/
const myNode7 = object.addSphere();
myNode7.center.set(1.32147,3.1149,0.755127);
myNode7.radius.set(2.0764994582229006);
