...
myNode0.point1.set(-0.45495,-4.99295,-4.06995);
myNode0.point2.set(18.09995,3.1759500000000003,4.08995);
myNode0.innerRotation.center.set(0,0,0);
myNode0.innerRotation.axis.set(-1.5707999999999998,0.0,0.0);
myNode0.innerRotation.angle.set(1.5707999999999998);
myNode0.innerTranslation.vector.set(8.8225,-0.9085000000000001,0.009999999999999787);
myNode0.isVisible = false;

/* définition du node n°1*/
const myNode1 = object.addCylinder();
myNode1.point1.set(-2.09,-3.18,-18.1);
myNode1.point2.set(-2.09,-3.18,0.4549999999999983);
...
myNode3.point1.set(-0.45495,3.17605,4.09005);
myNode3.point2.set(0.45395,4.09795,4.9979499999999994);
myNode3.innerRotation.center.set(0,0,0);
myNode3.innerRotation.axis.set(-1.5707999999999998,0.0,0.0);
myNode3.innerRotation.angle.set(1.5707999999999998);
myNode3.innerTranslation.vector.set(-0.0005000000000000004,3.637,4.544);
myNode3.isVisible = false;

/* définition du node n°4*/
const myNode4 = object.addCylinder();
myNode4.point1.set(-0.47,-4.07,-4.09795);
myNode4.point2.set(-0.47,-4.07,-3.17605);
...
myNode5.point1.set(-2.09,-3.18,-0.45495);
myNode5.point2.set(-2.09,-3.18,0.08995000000000003);
myNode5.radius.set(0.724);
...
myNode6.center.set(-0.453,-4.096,-4.09);
myNode6.radius.set(0.9048999944745275);
myNode6.isVisible = false;

/* définition du node n°7*/
const myNode7 = object.addCylinder();
myNode7.point1.set(3.182,4.092,-18.0999);
myNode7.point2.set(3.182,4.092,0.09099999999999753);
myNode7.radius.set(0.909);
...
myNode10.innerRotation.angle.set(1.5707926535897931);
...
myNode11.innerTranslation.vector.set(-0.0005000000000000004,6.9955,4.544);
...
myNode16.point1.set(0.819,-3.181,-0.455);
myNode16.point2.set(0.819,-3.181,18.1);
myNode16.radius.set(0.371);
...
myNode22.point1.set(4.099,0.451,-4.06995);
myNode22.point2.set(4.099,0.451,4.9979499999999994);
myNode22.radius.set(0.899);
...
myNode23.point1.set(-0.47,-4.07,-4.09795);
myNode23.point2.set(-0.47,-4.07,18.09995);
myNode23.radius.set(0.931);
...
myNode24.point1.set(-18.0999,3.17605,-4.06995);
myNode24.point2.set(18.099999999999998,4.09795,-3.1920500000000005);
...
myNode24.innerTranslation.vector.set(4.9999999998107114e-05,3.637,-3.6310000000000002);
myNode24.isVisible = false;

/* définition du node n°25*/
const myNode25 = object.addBox();
myNode25.point1.set(-18.0999,-4.10895,-3.19295);
myNode25.point2.set(18.099999999999998,4.097949999999999,4.0889500000000005);
...
myNode25.innerTranslation.vector.set(4.9999999998107114e-05,-0.0055000000000005045,0.44799999999999995);
myNode25.isVisible = false;

/* définition du node n°26*/
const myNode26 = object.addCylinder();
myNode26.point1.set(-4.101,4.096,-18.1);
myNode26.point2.set(-4.101,4.096,0.4549999999999983);
myNode26.radius.set(6.373);
...
myNode28.point1.set(3.182,4.092,0.09105);
myNode28.point2.set(3.182,4.092,18.09995);
myNode28.radius.set(0.909);
...
myNode29.point1.set(-4.083,-3.195,-18.0999);
myNode29.point2.set(-4.083,-3.195,18.099999999999998);
myNode29.radius.set(0.924);
...
myNode30_3.rightArg.set(myNode24);
...
myNode34.innerRotation.angle.set(1.5707926535897931);
...
myNode38.point1.set(-2.09,-3.18,0.091);
myNode38.point2.set(-2.09,-3.18,0.45499999999999996);
