#ifndef TORUS_CUBE_0_0_H
#define TORUS_CUBE_0_0_H
...
extern void glblInit_labels__ANONYMOUS_s140(bool* labels__ANONYMOUS_s139/* len = 31 */);
extern void glblInit_xs__ANONYMOUS_s142(float* xs__ANONYMOUS_s141/* len = 31 */);
extern void glblInit_ys__ANONYMOUS_s144(float* ys__ANONYMOUS_s143/* len = 31 */);
extern void glblInit_zs__ANONYMOUS_s146(float* zs__ANONYMOUS_s145/* len = 31 */);
extern void _main(int id, CuboidHint** cuboidHints__ANONYMOUS_s125/* len = 1 */, CylinderHint** cylinderHints__ANONYMOUS_s120/* len = 1 */, bool* labels__ANONYMOUS_s130/* len = 31 */, float* xs__ANONYMOUS_s131/* len = 31 */, float* ys__ANONYMOUS_s132/* len = 31 */, float* zs__ANONYMOUS_s133/* len = 31 */);
extern void check(int i, CuboidHint** cuboidHints__ANONYMOUS_s123/* len = 1 */, CylinderHint** cylinderHints__ANONYMOUS_s118/* len = 1 */, bool* labels__ANONYMOUS_s112/* len = 31 */, float* xs__ANONYMOUS_s113/* len = 31 */, float* ys__ANONYMOUS_s114/* len = 31 */, float* zs__ANONYMOUS_s115/* len = 31 */);
