#ifndef ONE_CYLINDER_0_0_H
#define ONE_CYLINDER_0_0_H
...
extern void glblInit_labels__ANONYMOUS_s136(bool* labels__ANONYMOUS_s135/* len = 6 */);
extern void glblInit_xs__ANONYMOUS_s138(float* xs__ANONYMOUS_s137/* len = 6 */);
extern void glblInit_ys__ANONYMOUS_s140(float* ys__ANONYMOUS_s139/* len = 6 */);
extern void glblInit_zs__ANONYMOUS_s142(float* zs__ANONYMOUS_s141/* len = 6 */);
extern void _main(int id, CuboidHint** cuboidHints__ANONYMOUS_s120/* len = 1 */, CylinderHint** cylinderHints__ANONYMOUS_s114/* len = 1 */, bool* labels__ANONYMOUS_s123/* len = 6 */, float* xs__ANONYMOUS_s124/* len = 6 */, float* ys__ANONYMOUS_s125/* len = 6 */, float* zs__ANONYMOUS_s126/* len = 6 */);
extern void check(int i, CuboidHint** cuboidHints__ANONYMOUS_s117/* len = 1 */, CylinderHint** cylinderHints__ANONYMOUS_s118/* len = 1 */, bool* labels__ANONYMOUS_s107/* len = 6 */, float* xs__ANONYMOUS_s108/* len = 6 */, float* ys__ANONYMOUS_s109/* len = 6 */, float* zs__ANONYMOUS_s110/* len = 6 */);
