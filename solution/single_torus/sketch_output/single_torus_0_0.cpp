...
void torus0(Vector* p, bool& _out) {
  bool  _out_s82=0;
  renderTorus(p, -(0.0278f), -(0.05229f), -(0.08639f), 0.01221f, 0.999904f, -(0.00653f), 0.0f, 0.00653f, 1.558586f, 3.52071f, 1.50166f, _out_s82);
  _out = _out_s82;
  return;
}
