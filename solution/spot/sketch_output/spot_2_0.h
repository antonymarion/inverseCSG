...
extern void glblInit_cuboidHints__ANONYMOUS_s152(CuboidHint** cuboidHints__ANONYMOUS_s151/* len = 6 */);
extern void glblInit_cylinderHints__ANONYMOUS_s154(CylinderHint** cylinderHints__ANONYMOUS_s153/* len = 5 */);
extern void glblInit_labels__ANONYMOUS_s156(bool* labels__ANONYMOUS_s155/* len = 524 */);
extern void glblInit_xs__ANONYMOUS_s158(float* xs__ANONYMOUS_s157/* len = 524 */);
extern void glblInit_ys__ANONYMOUS_s160(float* ys__ANONYMOUS_s159/* len = 524 */);
extern void glblInit_zs__ANONYMOUS_s162(float* zs__ANONYMOUS_s161/* len = 524 */);
extern void _main(int id, CuboidHint** cuboidHints__ANONYMOUS_s133/* len = 6 */, CylinderHint** cylinderHints__ANONYMOUS_s145/* len = 5 */, bool* labels__ANONYMOUS_s146/* len = 524 */, float* xs__ANONYMOUS_s147/* len = 524 */, float* ys__ANONYMOUS_s148/* len = 524 */, float* zs__ANONYMOUS_s149/* len = 524 */);
extern void check(int i, CuboidHint** cuboidHints__ANONYMOUS_s142/* len = 6 */, CylinderHint** cylinderHints__ANONYMOUS_s140/* len = 5 */, bool* labels__ANONYMOUS_s128/* len = 524 */, float* xs__ANONYMOUS_s129/* len = 524 */, float* ys__ANONYMOUS_s130/* len = 524 */, float* zs__ANONYMOUS_s131/* len = 524 */);
extern void contains(Vector* p, int num_primitives_0, bool& _out, CuboidHint** cuboidHints__ANONYMOUS_s141/* len = 6 */, CylinderHint** cylinderHints__ANONYMOUS_s135/* len = 5 */);
