...
if test_name == 'one_cube':
  ...
  os.system('python3 main.py --builddir %s --outdir ../ex_169 --mesh example/169/csg_high_res.off --eps 0.1 --surfacedensity 250 --volumedensity 25' % build_dir)
  ...
  os.system('python3 main.py --builddir %s --outdir ../mount --mesh example/mount/csg_high_res.off --eps 0.025 --surfacedensity 250 --volumedensity 25' % build_dir)
elif test_name == 'mount_with_hole':
  os.system('python3 main.py --builddir %s --outdir ../mount_with_hole --mesh example/mount_with_hole/csg_high_res.off --eps 0.025 --surfacedensity 250 --volumedensity 25' % build_dir)
elif test_name == 'lock':
  os.system('python3 main.py --builddir %s --outdir ../lock --mesh example/lock/csg_high_res.off --eps 0.025 --surfacedensity 250 --volumedensity 25' % build_dir)
elif test_name == 'tower_of_hanoi':
  os.system('python3 main.py --builddir %s --outdir ../tower_of_hanoi --mesh example/tower_of_hanoi/csg_low_res.off --eps 0.025 --surfacedensity 250 --volumedensity 25' % build_dir)
else:
